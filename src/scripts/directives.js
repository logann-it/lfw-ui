        ...
        return {
            ...
            template: [
                '<div class="form-group lfw-active-radio-button">',
                    '<div class="row">',
                        '<div class="col-sm-12">',
                            '<label><input type="radio" name="lfw-active-radio-button" ng-model="filter.active" value="true">{{"global.actions.active.true" | translate}}</label>',
                            '<label><input type="radio" name="lfw-active-radio-button" ng-model="filter.active" value="false">{{"global.actions.active.false" | translate}}</label>',
                            '<label><input type="radio" name="lfw-active-radio-button" ng-model="filter.active" value="">{{"global.actions.active.null" | translate}}</label>',
                        '</div>',
                    '</div>',
                '</div>'
            ].join('')
        ...
        return {
            ...
            compile: function(p_element, p_attrs) {
                ...
                if (p_attrs['maxHeight'] == null) {
                    div_responsive.attr('style', '');
                }
                else {
                    div_responsive.attr('style',  "max-height: "  + p_attrs['maxHeight'] + "px; overflow-y: auto; ")
                }
